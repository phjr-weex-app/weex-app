...
## 一 、 目录
<ul>
<li><a href="#xiangmuyunxingmingling">项目运行命令</a></li>
...
###<h3 id="xiangmuyunxingmingling">七 、Commands 项目运行命令</h3>
...
###<h3 id="iconbase64">八、本地图片转base64</h3>
1. 将configs/webpack.common.conf.js中，module.rules 下添加如下代码
...
2.开发环境（devDependencies）npm 安装url-loader模块，安装完成后package.json中多了 "url-loader": "^0.6.2" 依赖

3.src/mixins/index.js中添加全局方法
...
5. 注意事项
+ 图片仅限icon等小图片，经常要更换的可以放到服务器，最好使用网络图片
